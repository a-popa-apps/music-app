...
- [ ] Still missing, lower priority: a welcome email after verification, and an admin-notification email when new feedback is submitted (nothing currently alerts you to a new bug report/support request beyond checking the admin panel yourself).
