...
export function FinalCta() {
  return (
    <section className="w-full bg-black px-4 py-16 lg:px-12">
      <Reveal className="relative mx-auto max-w-7xl rounded-[calc(1rem+4px)] bg-gradient-to-r from-secondary-container to-[#ff3d78] p-[2px] shadow-[0_0_70px_rgba(255,107,53,0.3)]">
