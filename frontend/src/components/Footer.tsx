...
// "/#section" not "#section" -- this footer now renders on routes other
// than the landing page (see LegalPage.tsx), and a bare hash link only
// scrolls within the current page, so from e.g. /privacy it would just do
// nothing instead of navigating back to the landing page's section.
// Matches Header.tsx's NAV_LINKS, which already had to solve this.
const PRODUCT_LINKS = [
...
// TODO: placeholder URLs -- swap for the real handles.
const SOCIAL_LINKS = [
  {
    label: "Instagram",
    href: "https://instagram.com/crateprep",
  ...
  {
    label: "TikTok",
    href: "https://tiktok.com/@crateprep",
          ...
          <div className="flex items-center gap-4">
            {SOCIAL_LINKS.map((social) => (
              <a
                ...
                className="text-inverse-on-surface transition-colors hover:text-secondary-container"
              >
